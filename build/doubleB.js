...
(lib.doubleAnimB = function(mode,startPosition,loop) {
	...
	this.instance_89.setTransform(130.6,584.9,1,1,0,0,0,57.9,57.9);
	this.instance_89.alpha = 0.809;
	this.instance_89._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_89).wait(230).to({_off:false},0).wait(23).to({x:241.7,y:560.9,alpha:0.82},0).wait(24).to({x:442.6,y:631,alpha:0.809},0).wait(27).to({x:127.1,y:599.2},0).wait(23).to({x:249.7,y:550.9,alpha:0.82},0).wait(24).to({x:438.6,y:627,alpha:0.809},0).to({_off:true},28).wait(74));
