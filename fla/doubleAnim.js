...
(lib.doubleAnim = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(6).call(this.frame_6).wait(1).call(this.frame_7).wait(21).call(this.frame_28).wait(21).call(this.frame_49).wait(40).call(this.frame_89).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},51).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.instance_16}]},1).to({state:[{t:this.instance_17}]},1).to({state:[{t:this.instance_18}]},1).to({state:[{t:this.instance_19}]},1).to({state:[{t:this.instance_20}]},1).to({state:[{t:this.instance_21}]},1).to({state:[{t:this.instance_22}]},1).to({state:[{t:this.instance_23}]},1).to({state:[{t:this.instance_23}]},9).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(74).to({_off:false},0).to({scaleX:0.53,scaleY:0.43,x:332,y:608.9},9).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_24}]},29).to({state:[{t:this.instance_25}]},1).to({state:[{t:this.instance_26}]},1).to({state:[{t:this.instance_27}]},1).to({state:[{t:this.instance_28}]},1).to({state:[{t:this.instance_29}]},1).to({state:[{t:this.instance_30}]},1).to({state:[{t:this.instance_31}]},1).to({state:[{t:this.instance_32}]},1).to({state:[{t:this.instance_33}]},1).to({state:[{t:this.instance_34}]},1).to({state:[{t:this.instance_35}]},1).to({state:[{t:this.instance_36}]},1).to({state:[{t:this.instance_37}]},1).to({state:[{t:this.instance_38}]},1).to({state:[{t:this.instance_39}]},1).to({state:[{t:this.instance_40}]},1).to({state:[{t:this.instance_41}]},1).to({state:[{t:this.instance_42}]},1).to({state:[{t:this.instance_43}]},1).to({state:[{t:this.instance_44}]},1).to({state:[{t:this.instance_45}]},1).to({state:[]},25).wait(16));

	// hint
	this.instance_46 = new lib.Tween2("synched",0);
	this.instance_46.setTransform(300.6,492.7);
	this.instance_46.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_46).to({alpha:1},6).to({_off:true},1).wait(84));

	// h4
	this.instance_47 = new lib.Tween4("synched",0);
	this.instance_47.setTransform(320,258.2);
	this.instance_47.alpha = 0;
	this.instance_47._off = true;

	this.instance_48 = new lib.Tween5("synched",0);
	this.instance_48.setTransform(320,276.2);
	this.instance_48._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_47).wait(49).to({_off:false},0).to({_off:true,y:276.2,alpha:1},6).wait(36));
	this.timeline.addTween(cjs.Tween.get(this.instance_48).wait(49).to({_off:false},6).wait(7).to({startPosition:0},0).to({alpha:0},5).to({_off:true},1).wait(23));

	// h5
	this.instance_49 = new lib.Tween6("synched",0);
	this.instance_49.setTransform(320,232.4);
	this.instance_49.alpha = 0;
	this.instance_49._off = true;

	this.instance_50 = new lib.Tween7("synched",0);
	this.instance_50.setTransform(320,260.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_49}]},67).to({state:[{t:this.instance_50}]},6).to({state:[]},10).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_49).wait(67).to({_off:false},0).to({_off:true,y:260.4,alpha:1},6).wait(18));

	// s1
	this.instance_51 = new lib.Symbol1("synched",0);
	this.instance_51.setTransform(320,385.8,1,1,0,0,0,152.5,166);
	this.instance_51.alpha = 0;
	this.instance_51._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_51).wait(7).to({_off:false},0).to({y:530,alpha:1},21).to({_off:true},22).wait(41));

	// 2-1-f
	this.instance_52 = new lib.doublebg();

	this.timeline.addTween(cjs.Tween.get(this.instance_52).to({_off:true},90).wait(1));
